...
void ui_update_split(void)
{
    const ui_element elems[] = {
        ...
        { ELEM_TEXT , 0,                 TEXT_(split_note),      UI_6x8, TXT_LEFT, LINE_1, CTRL_SPLIT_ALL },
        { ELEM_ITEM , SPLIT_NOTE,        TEXT_(midi_note_names), UI_6x8, 70,       LINE_1, CTRL_SPLIT_ALL },


        { ELEM_TEXT , 0,                 TEXT_(output_sem),      UI_6x8, TXT_LEFT, LINE_2, CTRL_SPLIT_ALL },
        { ELEM_ITEM , SPLIT_SEND_TO_MIDI_OUT, TEXT_(midi_outs_split), UI_6x8, 50,  LINE_2, CTRL_SPLIT_ALL },
        ...
        { ELEM_TEXT , 0,                 TEXT_(send_to),         UI_6x8, 60,       LINE_3, CTRL_SPLIT_ALL },
        { ELEM_ITEM , SPLIT_SEND_CH1,    TEXT_(dry_fx),          UI_6x8, 105,      LINE_3, CTRL_SPLIT_ALL },
        ...
        { ELEM_TEXT , 0,                 TEXT_(send_to),         UI_6x8, 60,       LINE_4, CTRL_SPLIT_ALL },
        { ELEM_ITEM , SPLIT_SEND_CH2,    TEXT_(dry_fx),          UI_6x8, 105,      LINE_4, CTRL_SPLIT_ALL },
